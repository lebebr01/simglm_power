...
replicate_sim %>%
  ...
  knitr::kable(digits = 2, format = 'latex', booktabs = TRUE,
        ...
        col.names = c('Term', 'Avg Est', 'Power', 'Avg TS', 'Est SD', 'Avg SE', 
        'Precision', 'Repl'))
```
...
ggplot(power_results, aes(x = sample_size, y = power)) + 
  ...
  geom_vline(xintercept = min(filter(power_results, power >= 0.8)$power), linetype = 2, color = 'gray30') +
